...
describe('Component', () => {
  beforeEach(() => {
    ...
    test('test storyboard with mirador list', async ()  => {
      ...
      await wrapper.vm.$nextTick()
      expect(document.getElementsByClassName('content')[0].innerHTML.replace(/(\r\n|\n|\r)/gm, " ")).toEqual("<div class=\"tags\"><!----> <div id=\"balcony_tags\" class=\"\"><input type=\"checkbox\" class=\"tagscheck\"> <div class=\"countkey\">             balcony             <span class=\"tagscount\" style=\"background: white;\"><span>1</span></span></div></div><div id=\"partition_tags\" class=\"\"><input type=\"checkbox\" class=\"tagscheck\"> <div class=\"countkey\">             partition             <span class=\"tagscount\" style=\"background: red;\"><span>1</span></span></div></div><div id=\"railing_tags\" class=\"\"><input type=\"checkbox\" class=\"tagscheck\"> <div class=\"countkey\">             railing             <span class=\"tagscount\" style=\"background: green;\"><span>1</span></span></div></div></div>")
