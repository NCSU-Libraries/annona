...
describe('Component', () => {
  beforeEach(() => {
    ...
    test('test range list without canvases and settings', async ()  => {
      ...
      expect(Object.keys(sbd.shortcuts).sort()).toEqual(['autorun', 'textoverlay', 'close', 'fullscreen', 'hide', 'home', 'info', 'layers', 'next', 'overlay', 'prev', 'keyboard', 'transcription', 'zoomin', 'zoomout'].sort());
      wrapper.destroy()
    })
    ...
    test('test manifesturl range', async ()  => {
      ...
      expect(Object.keys(sbd.shortcuts).sort()).toEqual(['autorun', 'close', 'textoverlay', 'fullscreen', 'hide', 'home', 'info', 'next', 'nextanno', 'overlay', 'prev', 'prevanno', 'keyboard', 'zoomin', 'zoomout'].sort());
      wrapper.destroy()
    })
    ...
    test('test list of storyboardtags', async ()  => {
      ...
      expect(Object.keys(sbd.shortcuts).sort()).toEqual(['autorun', 'textoverlay', 'close', 'fullscreen', 'hide', 'home', 'info', 'next', 'nextanno', 'overlay', 'prev', 'prevanno', 'keyboard', 'zoomin', 'zoomout'].sort());
    ...
    test('test single list manifesturl', async ()  => {
      ...
      expect(Object.keys(sbd.shortcuts).sort()).toEqual(['autorun', 'textoverlay', 'close', 'fullscreen', 'hide', 'home', 'info', 'next', 'overlay', 'prev', 'keyboard', 'zoomin', 'zoomout'].sort());
      wrapper.destroy()
    })
    ...
    test('test v3 manifest with embedded annotations', async ()  => {
      ...
      expect(Object.keys(sbd.shortcuts).sort()).toEqual(['autorun', 'close', 'fullscreen', 'hide', 'home', 'info', 'next', 'overlay', 'prev', 'keyboard', 'zoomin', 'zoomout'].sort());
      wrapper.destroy()
    })
})