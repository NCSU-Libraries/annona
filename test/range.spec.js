...
describe('Component', () => {
  beforeEach(() => {
    ...
    test('test manifesturl with per page', async ()  => {
      ...
      expect(sbd.layerslist).toEqual([{"checked": true, "label": "Layer 1", "opacity": 1, "rotation": 0,"tile": "https://iiif.lib.ncsu.edu/iiif/technician-basketballspecial-1991-11_0001/info.json", "xywh": ""}]);
    ...
    test('test single list manifesturl', async ()  => {
      ...
      expect(sbd.layerslist).toEqual([{"checked": true, "label": "Layer 1", "opacity": 1, "rotation": 0,"tile": "https://images.cogapp.com/iiif/holbein_big_p.tif/info.json", "xywh": ""}]);
    ...
    test('test nested collection', async ()  => {
      ...
      expect(sbd.layerslist).toEqual([{"checked": true, "label": "Layer 1", "rotation": 0, "opacity": 1, "tile": "https://research.ng-london.org.uk/iiif/pics/pyramids/technicalbulletin/volume_31/N-0296_dirrO_0_a_AT-PYR.tif/info.json", "xywh": ""}]);
