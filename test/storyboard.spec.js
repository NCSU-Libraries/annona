...
describe('Component', () => {
  beforeEach(() => {
    ...
    test('test storyboard with mirador list', async ()  => {
      ...
      expect(data.tagslist).toEqual({"tags-balcony": {"checked": false, "color": "white", "count": 1, "group": undefined,  "key": "tags-balcony", "label": "balcony"}, "tags-partition": {"checked": false, "color": "red", "count": 1, "group": undefined,  "key": "tags-partition", "label": "partition"}, "tags-railing": {"checked": false, "color": "green", "count": 1, "group": undefined,  "key": "tags-railing", "label": "railing"}})
      const tagsButton = wrapper.find('#tagsButton')
      tagsButton.trigger('click')
      expect(data.shown).toBe('tags')
      await wrapper.vm.$nextTick()
      expect(document.getElementsByClassName('content')[0].innerHTML.replace(/(\r\n|\n|\r)/gm, " ")).toEqual("<div class=\"tags\"><!----> <div id=\"tags-balcony_tags\" class=\"\"><input type=\"checkbox\" class=\"tagscheck\"> <div class=\"countkey\">             balcony             <span class=\"tagscount\" style=\"background: white;\"><span>1</span></span></div></div><div id=\"tags-partition_tags\" class=\"\"><input type=\"checkbox\" class=\"tagscheck\"> <div class=\"countkey\">             partition             <span class=\"tagscount\" style=\"background: red;\"><span>1</span></span></div></div><div id=\"tags-railing_tags\" class=\"\"><input type=\"checkbox\" class=\"tagscheck\"> <div class=\"countkey\">             railing             <span class=\"tagscount\" style=\"background: green;\"><span>1</span></span></div></div></div>")
