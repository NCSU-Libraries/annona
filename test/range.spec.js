...
describe('Component', () => {
  beforeEach(() => {
    ...
    test('test range list without canvases and settings', async ()  => {
      ...
      expect(Object.keys(sbd.shortcuts).sort()).toEqual(['autorun', 'reload', 'textoverlay', 'close', 'fullscreen', 'hide', 'home', 'info', 'layers', 'next', 'overlay', 'prev', 'keyboard', 'transcription', 'zoomin', 'zoomout', 'settings'].sort());
      wrapper.destroy()
    })
    ...
    test('test manifesturl range', async ()  => {
      ...
      expect(sbd.layerslist).toEqual([{"checked": true, "label": "Layer 1", "rotation": 0, "opacity": 1, "tile": "https://iiif.lib.ncsu.edu/iiif/technician-basketballspecial-1991-11_0001/info.json", "xywh": "", "section": ""}]);
      expect(Object.keys(wrapper.vm.$children[0].$children[0].shortcuts).sort()).toEqual(['autorun', 'perpage', 'reload', 'close', 'textoverlay', 'fullscreen', 'hide', 'home', 'info', 'next', 'nextanno', 'overlay', 'prev', 'prevanno', 'keyboard', 'zoomin', 'zoomout', 'settings'].sort());
      wrapper.destroy()
    })
    ...
    test('test list of storyboardtags', async ()  => {
      ...
      expect(Object.keys(sbd.shortcuts).sort()).toEqual(['autorun', 'reload', 'textoverlay', 'close', 'fullscreen', 'hide', 'home', 'info', 'next', 'nextanno', 'overlay', 'prev', 'prevanno', 'keyboard', 'zoomin', 'zoomout', 'settings'].sort());
    ...
    test('test manifesturl with per page', async ()  => {
      ...
      expect(sbd.layerslist).toEqual([{"checked": true, "label": "Layer 1", "opacity": 1, "rotation": 0,"tile": "https://iiif.lib.ncsu.edu/iiif/technician-basketballspecial-1991-11_0001/info.json", "xywh": "", "section": ""}]);
      expect(Object.keys(wrapper.vm.$children[0].shortcuts).sort()).toEqual(['close', 'reload', 'textoverlay', 'fullscreen', 'hide', 'home', 'info', 'next', 'nextanno', 'overlay', 'prev', 'prevanno', 'keyboard', 'zoomin', 'zoomout', 'perpage', 'settings'].sort());
    ...
    test('test single list manifesturl', async ()  => {
      ...
      expect(sbd.layerslist).toEqual([{"checked": true, "label": "Layer 1", "opacity": 1, "rotation": 0,"tile": "https://images.cogapp.com/iiif/holbein_big_p.tif/info.json", "xywh": "", "section": ""}]);
      expect(Object.keys(sbd.shortcuts).sort()).toEqual(['autorun', 'reload', 'textoverlay', 'close', 'fullscreen', 'hide', 'home', 'info', 'next', 'overlay', 'prev', 'keyboard', 'zoomin', 'zoomout', 'settings'].sort());
      wrapper.destroy()
    })
    ...
    test('test v3 manifest with embedded annotations', async ()  => {
      ...
      expect(sbd.layerslist).toEqual([{"checked": true, "label": "Layer 1", "opacity": 1, "rotation": 0, "tile": "https://framemark.vam.ac.uk/collections/2013GU2911/info.json", "xywh": "", "section": ""}]);
    ...
    test('test nested collection', async ()  => {
      ...
      expect(sbd.position).toBe(-1);
      expect(sbd.seadragonid.indexOf('storyboard_') > -1).toEqual(true);
      ...
      expect(sbd.layerslist).toEqual([{"checked": true, "label": "Layer 1", "rotation": 0, "opacity": 1, "tile": "https://research.ng-london.org.uk/iiif/pics/pyramids/technicalbulletin/volume_31/N-0296_dirrO_0_a_AT-PYR.tif/info.json", "xywh": "", "section": ""}]);
      expect(Object.keys(sbd.shortcuts).sort()).toEqual(['reload', 'close', 'fullscreen', 'hide', 'home', 'info', 'keyboard', 'zoomin', 'zoomout', 'perpage','settings'].sort());
      wrapper.destroy()
    })
})