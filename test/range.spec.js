...
describe('Component', () => {
    ...
    test('test range list without canvases', async ()  => {
      ...
      expect(data.annotationurl).toEqual({"anno": "https://tomcrane.github.io/iiif-collector/objects/longer-article-annos1.json", "canvas": undefined, "jsonanno": undefined, "manifest": "", "section": "", "title": "Page 1"})
      expect(data.position).toEqual(0)
      expect(data.prevPageInactive).toBe(true)
    ...
    test('test range list without canvases and settings', async ()  => {
      ...
      expect(sbd.settings).toEqual({"autorun_interval": 3, "truncate_length": 2});
    ...
    test('test manifesturl range', async ()  => {
      ...
      expect(sbd.imagetitle).toBe("Technician Basketball Special, November 1991");
    ...
    test('test single list manifesturl', async ()  => {
      const wrapper =  mount(rangestoryboard,{
        propsData: {
          manifesturl: 'https://storiiies.cogapp.com/holbein/manifest.json'
        },
        attachToDocument: true
      });
      ...
      expect(data.annotationurl).toEqual({"anno": "https://storiiies.cogapp.com/holbein/annotations/list.json", "canvas": "https://storiies.cogapp.com/holbein/canvas/c0", "jsonanno": undefined, "manifest": "https://storiiies.cogapp.com/holbein/manifest.json", "section": undefined, "title": "Page 1"})
      expect(data.position).toEqual(0)
      expect(data.prevPageInactive).toBe(true)
      expect(data.nextPageInactive).toBe(true)
