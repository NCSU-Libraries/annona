...
describe('Component', () => {
  beforeEach(() => {
    ...
    test('test range list without canvases and settings', async ()  => {
      ...
      expect(Object.keys(sbd.shortcuts).sort()).toEqual(['autorun', 'close', 'fullscreen', 'hide', 'home', 'info', 'layers', 'next', 'overlay', 'prev', 'shortcut', 'transcription', 'zoomin', 'zoomout'].sort());
      wrapper.destroy()
    })
    ...
    test('test manifesturl range', async ()  => {
      ...
      expect(Object.keys(sbd.shortcuts).sort()).toEqual(['autorun', 'close', 'fullscreen', 'hide', 'home', 'info', 'next', 'nextanno', 'overlay', 'prev', 'prevanno', 'shortcut', 'zoomin', 'zoomout'].sort());
      wrapper.destroy()
    })
    ...
    test('test list of storyboardtags', async ()  => {
      ...
      expect(Object.keys(sbd.shortcuts).sort()).toEqual(['autorun', 'close', 'fullscreen', 'hide', 'home', 'info', 'next', 'nextanno', 'overlay', 'prev', 'prevanno', 'shortcut', 'transcription', 'zoomin', 'zoomout'].sort());
    ...
    test('test single list manifesturl', async ()  => {
      ...
      expect(sbd.layerslist).toEqual([{"checked": true, "label": "Layer 1", "opacity": 1, "tile": "https://images.cogapp.com/iiif/holbein_big_p.tif/info.json"}]);
      expect(Object.keys(sbd.shortcuts).sort()).toEqual(['autorun', 'close', 'fullscreen', 'hide', 'home', 'info', 'next', 'overlay', 'prev', 'shortcut', 'transcription', 'zoomin', 'zoomout'].sort());
      wrapper.destroy()
    })
