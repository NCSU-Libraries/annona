...
describe('Component', () => {
  beforeEach(() => {
    ...
    test('test storyboard with transcription', async ()  => {
      ...
      expect(data.currentanno).toEqual('')
      expect(wrapper.find('#information').html().replace(/[\r\n]/gm, " ").replace(/[  ]{2,}/gm, " ")).toEqual("<div id=\"information\" class=\"info content\" style=\"height: auto;\"> <div class=\"imagetitle\"> <h1></h1> </div> <span><!----> <!----> <!----> <!----> <button class=\"infolink buttonlink annoinfolink\">Annotation information</button> <!----> <!----> <!----></span> </div>")
      //wrapper.find('.annoinfolink').trigger('click')
      var contentpos1 = shared.createContent(data.annotations[0], null, data.settings, true);
      ...
      expect(wrapper.find('.content').html().replace(/[\r\n]/gm, " ").replace(/[  ]{2,}/gm, " ")).toEqual("<div id=\"transcription\" class=\"content\" style=\"\"><span><span style=\"direction: ltr;\"><div id=\"ocr\">BRITANIA INSVLA<div class=\"authorship\">Written by: https://recogito.pelagios.org/rainer</div></div></span></span></div>")
      wrapper.find('#transcription_button').trigger('click')
      await wrapper.vm.$nextTick()
      expect(wrapper.find('.content').html().replace(/[\r\n]/gm, " ").replace(/[  ]{2,}/gm, " ")).toEqual("<div id=\"annotation_text\" class=\"content\" style=\"\"><span><span style=\"direction: ltr;\"><div class=\"commenting\">The British Isles<div class=\"authorship\">Written by: https://recogito.pelagios.org/rainer</div></div></span></span> <!----> </div>")
